...
int main(int argc, char* argv[])
{
    ...
    std::string func_dmn_mesh_filename = "tagged_quad_curved_surf.vtk";
    ...
    std::string func_rng_mesh_filename = "tagged_delaunay_curved_surf.vtk";
    ...
    std::string interp_file = "curved_surf_output.vtk";
